resource "harness_platform_pipeline" "ci_harness_pipelines" {
...
resource "harness_platform_pipeline" "cd_harness_pipelines" {
  for_each = { for pipeline in local.cd_pipelines : pipeline.identifier => pipeline }
